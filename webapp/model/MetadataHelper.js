sap.ui.define([], function () {
    ...
    return [
        { key: "EmployeeID", label: "ID", path: "EmployeeID" },
        ...
        { key: "JoiningDate", label: "Joining Date", path: "JoiningDate" },
        ...
        { key: "MaritalStatus", label: "Marital Status", path: "MaritalStatus" },
        { key: "MaritalStatus", label: "Education", path: "Education" },
